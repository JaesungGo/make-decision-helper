...
import com.example.make_decision_helper.domain.chatuser.dto.ChatUserDto;
import com.example.make_decision_helper.domain.chatuser.dto.GuestUserDTO;
...
public class RoomResponse {
    ...
    public RoomResponse(Long id, String title, String inviteCode,
                        int maxParticipants, int participantsSize, ChatRoom.RoomStatus roomStatus) {
        this.roomId = id;
        this.title = title;
    ...
    public static RoomResponse toGuest(ChatRoom chatRoom, ChatUser currentUser, InviteCode inviteCode) {
        return RoomResponse.builder()
                .roomId(chatRoom.getId())
                .title(chatRoom.getTitle())
                .inviteCode(inviteCode.getInviteCode())
